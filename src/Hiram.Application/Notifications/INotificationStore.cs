...
{
    // The request and its outbox message must be persisted in a single transaction.
    // Losing one without the other is the exact failure this platform exists to prevent.
